...
def generate_report(grades, report_file_path):
    ...
    report_content = f"Average Grade: {average_grade:.2f}\n"
    report_content += f"Highest Grade: {highest_student} ({highest_grade})\n"
    report_content += f"Lowest Grade: {lowest_student} ({lowest_grade})"
